        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="progress mb-2" style="height: 30px;">
                    <div class="progress-bar bg-success" role="progressbar" style="width: {{ ($stats['sukses'] / $stats['total']) * 100 }}%">
                        Sukses: {{ round(($stats['sukses'] / $stats['total']) * 100) }}%
                    </div>
                </div>
                <div class="progress" style="height: 30px;">
                    <div class="progress-bar bg-danger" role="progressbar" style="width: {{ ($stats['gagal'] / $stats['total']) * 100 }}%">
