    ...
    <div class="max-w-6xl mx-auto space-y-8">
        <header class="flex flex-wrap items-end justify-between gap-4">
            ...
            <a href="{{ route('home') }}"
               class="inline-flex items-center px-3 py-1.5 text-xs font-medium border border-neutral-700
                      rounded-md text-neutral-300 hover:bg-neutral-900 transition-colors">
                Upload dataset lain
            </a>
        </header>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <section class="lg:col-span-1 space-y-4">
                <div class="bg-neutral-900 border border-neutral-800 rounded-md p-4">
                    ...
                    <dl class="space-y-1 text-sm">
                        <div class="flex justify-between">
                            ...
                            <dd class="font-medium">{{ $metrics['total_data'] ?? 0 }}</dd>
                        </div>
                            ...
                            @foreach ($metrics['attributes'] as $attr)
                                <div class="flex items-center justify-between">
                                    ...
                                    <span class="font-mono text-amber-400">
                                        {{ number_format($attr['gain_ratio'], 4) }}
                                    </span>
                                </div>
                            @endforeach
                        </div>
            ...
            <section class="lg:col-span-2">
                <div class="bg-neutral-900 border border-neutral-800 rounded-md p-4 md:p-6">
                    ...
                    @else
                        <p class="text-sm text-neutral-400">
                            Pohon keputusan belum tersedia.
                        </p>
                    @endif
                </div>
            </section>
